...
const METRICS_DATA: MetricItem[] = [
  {
    value: "5",
    label: "Клубных вилл",
    description: "Камерный закрытый комплекс резиденций у подножия гор.",
  },
  {
    value: "2",
    label: "Этажа",
    description: "Общественная зона и приватное крыло спален на двух уровнях.",
  },
  {
    value: "5 мин",
    label: "До горных маршрутов",
    description: "Прямой выход к пешим тропам Заилийского Алатау.",
  },
];
