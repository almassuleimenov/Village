        ...
        >
          <motion.section className={styles.section} variants={fadeUp}>
            ...
            <p className={styles.text}>
              Вся информация, представленная на данном веб-сайте, включая 3D-визуализации, планировки, генплан, текстовые описания и технические характеристики проекта V Club Villas, носит исключительно информационный (ознакомительный) характер. Ни при каких условиях материалы сайта не являются публичной офертой, определяемой положениями гражданского законодательства.
            </p>
          </motion.section>
          ...
          <motion.section className={styles.section} variants={fadeUp}>
            ...
            <p className={styles.text}>
              Все элементы дизайна, текст, графика, логотипы, видео, изображения и программный код являются интеллектуальной собственностью V Club Villas или ее лицензиаров. Любое копирование, распространение или использование материалов сайта в коммерческих целях без письменного разрешения правообладателя строго запрещено и преследуется по закону.
            </p>
          </motion.section>
