...
## src/components/Advantages/Advantages.module.css
...
/* Изменения для Baseline Alignment: элементы идут сверху вниз без прижимания */
.cardContent {
  position: relative;
  z-index: 1;
  display: flex;
...
.iconWrapper {
  ...
  /* Фиксированный отступ вместо auto, чтобы иконка не расталкивала контент */
  margin-bottom: 40px; 
}
...
.cardTitle {
  ...
  /* Резервируем высоту на 2 строки для выравнивания описаний по базовой линии */
  min-height: 2.8em; 
  display: flex;
...
@media (max-width: 768px) {
  ...
  .cardTitle {
    min-height: auto; /* На мобилке выравнивание не нужно, карточки идут друг за другом */
  }
...
## src/app/terms-of-use/Legal.module.css
...
.noise {
  ...
  /* ИСправлено: Легкий статический Base64 шум вместо тяжелого математического SVG */
  background-image: url("data:image/png;base64,");
  background-repeat: repeat;
  
  /* Простая прозрачность вместо тяжелого mix-blend-mode: overlay */
  opacity: 0.04; 
...
/* src/components/CinematicTour/CinematicTour.module.css */
/* НАЙДИ ЭТОТ БЛОК И ЗАМЕНИ НА КОД НИЖЕ */
...
.cinematicOverlay {
  ...
  /* УДАЛИЛИ mix-blend-mode: multiply; */
}
